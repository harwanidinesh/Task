...
namespace Greenlab\Blog\Model;

use Greenlab\Blog\Api\Data\PostInterface;
use Greenlab\Blog\Model\Post\File;
use Greenlab\Blog\Model\Config\Config;
...
class Post extends AbstractModel implements IdentityInterface, PostInterface
{
    ...
    {
        $this->_init('Greenlab\Blog\Model\ResourceModel\Post');
    }
